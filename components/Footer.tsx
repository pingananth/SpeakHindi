...
export default function Footer() {
    ...
    return (
            ...
            <div className="container">
                <div className="footer-content">
                    <div className="footer-brand">
                        <h3 className="brand-name">SpeakHindi</h3>
                        <p className="brand-tagline">Master Hindi conversation without scripts</p>
                    </div>
        ...
        .brand-name {
          ...
          background: linear-gradient(90deg, var(--color-neutral-white) 0%, var(--color-teal-light) 100%);
